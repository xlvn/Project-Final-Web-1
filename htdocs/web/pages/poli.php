            ...
            <div class="row">
              ...
              <div class="col-lg-6 col-5 my-auto text-end">
                <div class="float-lg-end pe-4">
                  <!-- Tombol untuk membuka modal tambah poli -->
                  <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#tambahPoliModal">
                    Tambah Poli Baru
                  </button>
                  <!-- Tambah Form Poli -->
                  <div class="modal fade" id="tambahPoliModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <form id="formPoli" action="poli.php" method="post">
                            <div class="mb-3">
                ...
                <tbody>
                  ...
                  if ($result->num_rows > 0) {
                      ...
                      while($row = $result->fetch_assoc()) {
                          ...
                          echo "<td class='text-xs font-weight-bold text-center'><a href='edit_poli.php?id=" . $row["id"] . "' class='btn btn-third' style='margin-left: 5px; margin-right: 5px;'>Edit</a></td>";
                          // Link untuk menghapus data
                          echo "<td class='text-xs font-weight-bold text-center'><a href='delete_poli.php?id=" . $row["id"] . "' class='btn btn-secondary'>Hapus</a></td>";
                          echo "</tr>";
                      }
                  } else {
                      echo "<tr><td colspan='5' class='text-center'>No records found</td></tr>"; // Perbarui colspan sesuai jumlah kolom
                  }
                  $conn->close();
                  ?>
                </tbody>
