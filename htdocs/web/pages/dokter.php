                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <form id="formDokter" action="dokter.php" method="post">
                            <div class="mb-3">
                ...
                <tbody>
                  ...
                  if ($result->num_rows > 0) {
                      ...
                      while($row = $result->fetch_assoc()) {
                          ...
                          echo "<td class='text-xs font-weight-bold text-center'><a href='edit_dokter.php?id=" . $row["id"] . "' class='btn btn-third' style='margin-left: 5px; margin-right: 5px;'>Edit</a></td>";
                          // Link untuk menghapus data
                          echo "<td class='text-xs font-weight-bold text-center'><a href='delete_dokter.php?id=" . $row["id"] . "' class='btn btn-secondary'>Hapus</a></td>";
                          echo "</tr>";
                      }
                  } else {
                      echo "<tr><td colspan='7' class='text-center'>No records found</td></tr>"; // Perbarui colspan sesuai jumlah kolom
                  }
                  $conn->close();
                  ?>
                </tbody>
