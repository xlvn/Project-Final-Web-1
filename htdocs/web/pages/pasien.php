            ...
            <div class="row">
              ...
              <div class="col-lg-6 col-5 my-auto text-end">
                <div class="float-lg-end pe-4">
                  <!-- Tombol untuk membuka modal tambah pasien -->
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <form id="formPasien" action="pasien.php" method="post">
                            <div class="mb-3">
                ...
                <tbody>
                  ...
                  if ($result->num_rows > 0) {
                      ...
                      while($row = $result->fetch_assoc()) {
                          ...
                          echo "<td class='text-xs font-weight-bold text-center'><a href='edit_pasien.php?id=" . $row["id"] . "' class='btn btn-third' style='margin-left: 5px; margin-right: 5px;'>Edit</a></td>";
                          echo "<td class='text-xs font-weight-bold text-center'><a href='delete_pasien.php?id=" . $row["id"] . "' class='btn btn-secondary'>Hapus</a></td>";
                          echo "</tr>";
                      }
                  } else {
                      echo "<tr><td colspan='8' class='text-center'>No records found</td></tr>"; // Perbarui colspan sesuai jumlah kolom
                  }
                  $conn->close();
                  ?>
                </tbody>
