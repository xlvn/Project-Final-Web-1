...
// Asumsikan id_dokter yang sedang login disimpan dalam session
$id_dokter = $_SESSION['id_dokter'];

// Query untuk mendapatkan data dari tabel periksa hanya untuk id_dokter yang sesuai
$query = "SELECT rp.id, rp.id_daftar_poli, rp.tgl_periksa, rp.catatan, rp.biaya_periksa 
          FROM periksa rp
                            ...
                            <table class="table align-items-center mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">ID Daftar Poli</th>
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
      ...
      echo "<td>" . date("d F, Y", strtotime($row["tgl_periksa"])) . "</td>";
